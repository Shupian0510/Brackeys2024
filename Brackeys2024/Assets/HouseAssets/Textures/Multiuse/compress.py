...
# 设置输入目录和输出目录
input_directory = r'e:\BrackeysGameJam\Brackeys2024\Brackeys2024\Assets\HouseAssets\Textures'  # 替换为你的实际目录
output_directory = r'e:\BrackeysGameJam\Brackeys2024\Brackeys2024\Assets\HouseAssets\Textures\Compressed'  # 替换为保存压缩后的文件的目录
